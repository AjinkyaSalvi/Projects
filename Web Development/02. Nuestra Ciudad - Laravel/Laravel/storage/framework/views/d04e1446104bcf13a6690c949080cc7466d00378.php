    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div class="content_wrap"><br>
              <a href="<?php echo e(route('admindashboard')); ?>"><h2 class="orange_italic">< Back to Admin dashboard</h2></a>
              <br><br>
                <div class="userd_events_grid">
                   <h2 class="orange_italic"> Edit this Blog</h2>
                   <br>
                   <form class='login_form' action='<?php echo e(route('updateblog')); ?>' method='post'>
                     <?php echo csrf_field(); ?>
                       <?php $__currentLoopData = $blogdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <br>
                                                        <input type='hidden' name='blog_hidden_id'  value="<?php echo e($item->Bid); ?>">
                                                        <label for='event_namee' class='grey_color'>Blog Name:</label><br><br>
                                                        <input type='text' name='blog_namee' class='login_input' required value="<?php echo e($item->Bname); ?>"><br><br>

                                                        <label for='event_date' class='grey_color'>Blog Date: </label><br><br>
                                                        <input type='date' name ='blog_date' class='login_input' required value="<?php echo e($item->Bdate); ?>"><br><br>

                                                         <label for='event_description' class='grey_color'>Blog Description: </label><br><br>
                                <textarea name='blog_description' class='dashboard_input'>
                                    <?php echo e($item->Bcontent); ?>

                                </textarea>
                                <br>
                                <input type='submit' value='Update Blog' name='blog_update_btn' class='login_button' id='white' >
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/editblog.blade.php ENDPATH**/ ?>