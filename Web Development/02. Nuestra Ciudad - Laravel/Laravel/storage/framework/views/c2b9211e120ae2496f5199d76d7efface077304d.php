            ...
            <div class="content_wrap"><br>
              ...
              <br><br>
                <div class="userd_events_grid">
                   ...
                   <br>
                   <form class='login_form' action='<?php echo e(route('insertevent')); ?>' method='post'>
                     <?php echo csrf_field(); ?>
                                                        <br>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/addevent.blade.php ENDPATH**/ ?>