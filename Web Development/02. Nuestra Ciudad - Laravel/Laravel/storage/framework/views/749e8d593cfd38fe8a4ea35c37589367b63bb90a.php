     ...
     <div id="wrapper">
          ...
          <div class="content_wrap">
               ...
               <div class="userd_events_grid">
                    <table>
                         <form method="post" action="<?php echo e(route('contact_us_update')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/dynamic/contactusinsert.blade.php ENDPATH**/ ?>