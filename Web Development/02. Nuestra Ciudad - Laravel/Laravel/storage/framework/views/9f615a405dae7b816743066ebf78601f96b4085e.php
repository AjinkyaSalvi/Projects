...
<body>
     <div id="wrapper">
          ...
          <!--Row 01-->
          <div class="userd_events_grid">
               <form method="post" action="<?php echo e(route('values_update')); ?>">
                    <b> CALIDAD </b>
                    <br>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/dynamic/ourvaluesinsert.blade.php ENDPATH**/ ?>