            ...
            <div class="content_wrap"><br>
              ...
              <br><br>
                <div class="userd_events_grid">
                   ...
                   <br>
                   <form class='login_form' action='<?php echo e(route('insertblog')); ?>' method='post'>
                     <?php echo csrf_field(); ?>
                          <br>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/addblog.blade.php ENDPATH**/ ?>