            ...
            <div class="content_wrap"><br>
              ...
              <br><br>
                <div class="userd_events_grid">
                   ...
                   <br>
                   <form class='login_form' action='<?php echo e(route('updateevent')); ?>' method='post'>
                     <?php echo csrf_field(); ?>
                       <?php $__currentLoopData = $eventdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <br>
                                                        <input type='hidden' name='event_hidden_id'  value="<?php echo e($item->Eventid); ?>">
                                                        <label for='event_namee' class='grey_color'>Event Name:</label><br><br>
                                                        <input type='text' name='event_namee' class='login_input' required value="<?php echo e($item->Ename); ?>"><br><br>

                                                        <label for='event_date' class='grey_color'>Event Date: </label><br><br>
                                                        <input type='date' name ='event_date' class='login_input' required value="<?php echo e($item->Edate); ?>"><br><br>

                                                         <label for='event_description' class='grey_color'>Event Description: </label><br><br>
                                <textarea name='event_description' class='dashboard_input'>
                                    <?php echo e($item->Edescription); ?>

                                </textarea>
                                <br>
                                <input type='submit' value='Update Event' name='event_update_btn' class='login_button' id='white' >
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/editevent.blade.php ENDPATH**/ ?>