        ...
        <div class="content_wrap">
          ...
          <!---Edit content Starts here-------------------------------------------------->
                <div class="userd_events_grid">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <button name='home_page_edit' class='login_button' onclick="window.location='<?php echo e(route('home_edit')); ?>'"> Home Page</button>
                            </td>
                            <td>
                                <button name='aboutus_page_edit'class='login_button' onclick="window.location='<?php echo e(route('about_us_edit')); ?>'"> About Us </button>
                            </td>
                            <td>
                                <button name='team_page_edit' class='login_button'> Team Page</button>
                            </td>
                             <td>
                                <button name='contact_page_edit' class='login_button' onclick="window.location='<?php echo e(route('contact_us_edit')); ?>'"> Contact Us Page</button>
                            </td>
                        </tr>
                ...
                <div class="userd_events_grid">
                 ...
                 <table>
                  <form method="post" action="<?php echo e(route('edit_event')); ?>" >
                    <?php echo csrf_field(); ?>
          ...
          <!---End of events--------------------------------->
              ...
              <div class="userd_events_grid">
                ...
                <table>
                <form method="post" action="<?php echo e(route('edit_blog')); ?>">
                  <?php echo csrf_field(); ?>
                  ...
                  <tr class='user_events_info_td'>
                      <td class='userd_events_info_td'>
                          <input type='radio' name='blog_choice' required value='<?php echo e($item->Bid); ?>'>
                      </td>
                      <td class='user_events_info_td'><?php echo e($item->Bname); ?></td>
                      <td class='user_events_info_td' id='padding3'>
                              <font id='gray'>Blog date :</font> <?php echo e($item->Bdate); ?>
