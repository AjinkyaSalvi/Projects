     ...
     <div id="wrapper">
          ...
          <div class="content_wrap">
               ...
               <div class="userd_events_grid">
                    ...
                    <form method="post" action="<?php echo e(route('home_update')); ?>">
                         <?php echo csrf_field(); ?>
                         <textarea name='gente' class='content_input'>
                              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php echo e($item->HBanner); ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/dynamic/homeinsert.blade.php ENDPATH**/ ?>