     ...
     <div id="wrapper">
          ...
          <div class="content_wrap">
               ...
               <div class="userd_events_grid">
                    ...
                    <form method="post" action="<?php echo e(route('about_us_update')); ?>">
                         <?php echo csrf_field(); ?>
                         <textarea name='txt_mission' class='content_input'>
                              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php echo e($item->AUMission); ?>
               ...
               <!--Go to 'Our Values'-->
               <div class="userd_events_grid">
                    <button  name="edit_objectives" value="Edit Nuestros Valores" title="Add Blog" class="contact_us_form_btn" onclick="window.location='<?php echo e(route('values_edit')); ?>'">Our Values</button>
                    <br><br>
               </div>
               <br>
          </div>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/admin/dynamic/aboutusinsert.blade.php ENDPATH**/ ?>