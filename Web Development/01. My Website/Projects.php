                    ...
                    <div class="nGrid">
                         <nav class="nLAdjust">
                              ...
                              <a href="Projects.php" class="nLink01">
                                   <button class="aNButton01">Projects</button>
                              </a>
               ...
               <?php
                    if($q01 = mysqli_query($mysqli,"SELECT * FROM projects;")) {
                         while($row01 = mysqli_fetch_array($q01)){
                              $prTitle = $row01[prtitle];
                              $prBody = $row01[prbody];
                              $prMajors = $row01[prmajors];
                              $prLanguages = $row01[prlanguages];

                              echo "
                                   <div class='box01'>
                                        <strong>$prTitle</strong>

                                        <div class='box02'>$prBody</div>
                                        <div class='box02'>$prMajors</div>
                                        <div class='box02'>$prLanguages</div>
                                   </div>
                              ";
                         }
                    }
