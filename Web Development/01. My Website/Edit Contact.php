...
<html>
     ...
     <body class="body">
                    ...
                    <div class="nBar02">
                         ...
                         <nav class='nLAdjust'>
                              ...
                              <a href='Edit Contact.php' class='nLink02'>
                                   <button class='aNButton02'>Contact</button>
                              </a>
                         </nav>
                    </div>
               </div>
          ...
          <div>
               ...
               <?php
                    //   ---===###===---   ---===###===---   ---===###===---   I. Update Contact   ---===###===---
                    if($q01 = mysqli_query($mysqli,"SELECT * FROM contact;")) {
                         echo "
                              <div class='box01'>
                                   <strong>Update Contact</strong>
                                   <form action='./Backend/Update Contact.php' method='post'>
                                        Select contact:
                                        <select name='uCSelected' class='iSelect' required>
                                             <option value=''>No contact selected.</option>
                         ";

                         while($row01 = mysqli_fetch_array($q01)) {
                              $uCID = $row01[cid];
                              $uCTitle = $row01[ctitle];
                              $uCDate = $row01[cdate];
                              $uCTime = $row01[ctime];

                              echo "<option value='$uCID'>$uCTitle - Last updated on $uCDate at $uCTime.</option>";
                         }
                         ...
                         echo "
                                        ...
                                        <label for='uCT'>Update contact title:</label>
                                        <input name='uCT' type='text' class='iText' placeholder='Enter title.'>
                                        <button name='uCTButton' class='sButtons'>Update</button>
                                        <br>

                                        <label for='uCB'>Update contact body:</label>
                                        <input name='uCB' type='text' class='iText' placeholder='Enter body.'>
                                        <button name='uCBButton' class='sButtons'>Update</button>
                                   </form>
                              </div>
                         ";
                    }
                    ...
                    echo "
                         <div class='box01'>
                              ...
                              <form action='./Backend/Update Contact.php' method='post'>
                                   <label for='aCT'>Add contact title:</label>
                                   <input name='aCT' type='text' class='iText' placeholder='Enter title.' required>
                                   <br>

                                   <label for='aCB'>Add contact body:</label>
                                   <input name='aCB' type='text' class='iText' placeholder='Enter body.' required>
                                   <br>

                                   <button name='aCButton' class='sButtons'>Add</button>
                              </form>
                         </div>
                    ";

                    //   ---===###===---   ---===###===---   ---===###===---   III. Delete Activity   ---===###===---
                    if($q02 = mysqli_query($mysqli,"SELECT * FROM contact;")) {
                         echo "
                              <div class='box01'>
                                   <strong>Delete Contact</strong>
                                   <form action='./Backend/Update Contact.php' method='post'>
                                        Select Contact:
                                        <select name='dCSelected' class='iSelect' required>
                                             <option value=''>No contact selected.</option>
                         ";

                         while($row02 = mysqli_fetch_array($q02)) {
                              $dCID = $row02[cid];
                              $dCTitle = $row02[ctitle];
                              $dCDate = $row02[cdate];
                              $dCTime = $row02[ctime];

                              echo "<option value='$dCID'>$dCTitle - Last updated on $dCDate at $dCTime.</option>";
                         }
                         ...
                         echo "
                                        ...
                                        <label for='dCButton'>Delete selected contact:</label>
                                        <button name='dCButton' class='sButtons'>Delete</button>
                                   </form>
                              </div>
                         ";
                    }
