...
<html>
     ...
     <body class="body">
          ...
          <div>
               <nav class="tBox01">
                    <a href="About Me.php" class="tab01">About Me</a>
                    <a href="About Website.php" class="tab02">About Website</a>
               </nav>

               <div class="tBox02">
                    <?php
                         if($q01 = mysqli_query($mysqli, "SELECT * FROM asw.photo WHERE phid='1'")) {
                              if($row01 = mysqli_fetch_array($q01)) {
                                   $phFLocation = "/All-Star Database/Ajinkya Salvi/Photo/".$row01[pfname];
                                   echo "
                                        <div class='aPhoto'>
                                             <img src='.$phFLocation.' class='photo'>
                                        </div>
                                   ";
                              }
                         }
                         ...
                         if($q02 = mysqli_query($mysqli,"SELECT * FROM ame;")) {
                              ...
                              while($row02 = mysqli_fetch_array($q02)){
                                   $aMTitle = $row02[amtitle];
                                   $aMBody = $row02[ambody];

                                   echo "
                                        <div class='bGrid'>
                                             <div class='box03'>
                                                  <strong>$aMTitle</strong>
                                             </div>

                                             <div class='box04'>$aMBody</div>
                                        </div>
                                   ";
                              }
                         }
