                    ...
                    <div class="nGrid">
                         <nav class="nLAdjust">
                              ...
                              <a href="Education.php" class="nLink01">
                                   <button class="aNButton01">Education</button>
                              </a>
          ...
          <div>
               <?php
                    if($q01 = mysqli_query($mysqli,"SELECT * FROM education;")) {
                         echo "<div class='eTLeft'>&#127891;</div>";
                         while($row01 = mysqli_fetch_array($q01)){
                              $edDegree = $row01[degree];
                              $edUniversity = $row01[university];
                              $uLocation = $row01[ulocation];
                              $gDate = $row01[gdate];

                              echo "<div class='box01'>Earned a $edDegree from the $edUniversity, $uLocation - $gDate</div>";
                         }
                    }
               ?>
          </div>
