     ...
     <body class="body">
                    ...
                    <div class="nGrid">
                         <nav class="nLAdjust">
                              <a href="Home.php" class="nLink01">
                                   <button class="aNButton01">Home</button>
                              </a>
          ...
          <div>
               <?php
                    ...
                    echo "
                         <div class='box01'>$hBody</div>

                         <div class='eBLeft'>&#128041;</div>
                    ";

                    //   ---===###===---   ---===###===---   ---===###===---   II. Resume   ---===###===---
                    $q02 = mysqli_query($mysqli, "SELECT * FROM asw.resumef WHERE resid='1'");
                    while($row02 = mysqli_fetch_array($q02)) {
                         $resFLocation = "/All-Star Database/Ajinkya Salvi/Resume/".$row02[resfname];
                         echo "
                              <div class='eTRight'>&#128031;</div>

                              <div class='box01'>
                                   <strong>View My Resume</strong>
                                   <br>

                                   <a href='.$resFLocation.' target='_blank' rel='noopener noreferrer'>
                                        <img src='All-Star Database/Ajinkya Salvi/Website/File.png' class='fImage' title='Click to view the Resume.'>
                                   </a>
                              </div>
                         ";
                    }
