                    ...
                    <div class="nBar02">
                         ...
                         <nav class='nLAdjust'>
                              ...
                              <a href='Edit Projects.php' class='nLink02'>
                                   <button class='aNButton02'>Projects</button>
                              </a>
               ...
               <?php
                    ...
                    echo "
                         <div class='box01'>
                              ...
                              <form action='./Backend/Update Projects.php' method='post'>
                    ";

                    if($q01 = mysqli_query($mysqli,"SELECT * FROM projects;")) {
                         echo "
                              Select project:
                              <select name='uPrSelected' class='iSelect' required>
                                   <option value=''>No project selected.</option>
                         ";

                         while($row01 = mysqli_fetch_array($q01)) {
                              $uPrID = $row01[prid];
                              $uPrTitle = $row01[prtitle];
                              $uPrDate = $row01[prdate];
                              $uPrTime = $row01[prtime];

                              echo "<option value='$uPrID'>$uPrTitle - Last updated on $uPrDate at $uPrTime.</option>";
                         }
                         ...
                         echo "
                                        ...
                                        <label for='uPrTitle'>Update project title:</label>
                                        <input name='uPrTitle' type='text' class='iText' placeholder='Enter project title.'>
                                        <button name='uPrTButton' class='sButtons'>Update</button>
                                        <br>

                                        <label for='uPrBody'>Update project body:</label>
                                        <br>
                                        <textarea name='uPrBody' class='iTArea' placeholder='Enter project body.'></textarea>
                                        <button name='uPrBButton' class='sButtons'>Update</button>
                                        <br>

                                        <label for='uPrMajors'>Update project majors:</label>
                                        <input name='uPrMajors' type='text' class='iText' placeholder='Enter project majors.'>
                                        <button name='uPrMButton' class='sButtons'>Update</button>
                                        <br>

                                        <label for='uPrLanguages'>Update project languages:</label>
                                        <input name='uPrLanguages' type='text' class='iText' placeholder='Enter project languages.'>
                                        <button name='uPrLButton' class='sButtons'>Update</button>
                                   </form>
                              </div>
                         ";
                    }
                    ...
                    echo "
                         <div class='box01'>
                              ...
                              <form action='./Backend/Update Projects.php' method='post'>
                                   <label for='aPrTitle'>Add project title:</label>
                                   <input name='aPrTitle' type='text' class='iText' placeholder='Enter project title.' required>
                                   <br>

                                   <label for='aPrBody'>Add project body:</label>
                                   <br>
                                   <textarea name='aPrBody' class='iTArea' placeholder='Enter project body.' required></textarea>
                                   <br>

                                   <label for='aPrMajors'>Add project majors:</label>
                                   <input name='aPrMajors' type='text' class='iText' placeholder='Enter project majors.' required>
                                   <br>

                                   <label for='aPrLanguages'>Add project languages:</label>
                                   <input name='aPrLanguages' type='text' class='iText' placeholder='Enter project languages.' required>
                                   <br>

                                   <button name='aPrButton' class='sButtons'>Add</button>
                              </form>
                         </div>
                    ";
                    ...
                    if($q02 = mysqli_query($mysqli,"SELECT * FROM projects;")) {
                         echo "
                              Select project:
                              <select name='dPrSelected' class='iSelect' required>
                                   <option value=''>No project selected.</option>
                         ";

                         while($row02 = mysqli_fetch_array($q02)) {
                              $dPrID = $row02[prid];
                              $dPrTitle = $row02[prtitle];
                              $dPrDate = $row02[prdate];
                              $dPrTime = $row02[prtime];

                              echo "<option value='$dPrID'>$dPrTitle - Last updated on $dPrDate at $dPrTime.</option>";
                         }
                         ...
                         echo "
                                        ...
                                        <label for='dPrButton'>Delete selected project:</label>
                                        <button name='dPrButton' class='sButtons'>Delete</button>
                                   </form>
                              </div>
                         ";
                    }
